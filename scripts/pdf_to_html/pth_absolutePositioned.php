...
class pth_absolutePositioned
{
    ...
    public function __construct(&$obj)
    {
        ...
        {           
            ...
            for($n=0;$n<$loop;$n++)
            {
                    ...
                    {
                        if(!$this->blockInBoundary($properties,$objBoundary,$left))                     { continue; }
        ...
        {  
            ...
            digi_pdf_to_html::mergeBlocks($obj, $src, $tgt, false);  
    ...
    //###########################################################
    private function blockInBoundary(array $properties, array $objBoundary, int $left):bool
    {
        if(
            $properties['tag'] === "image"
